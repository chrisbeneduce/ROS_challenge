...
(cl:in-package holonomic_robot-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ManualCommands-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ManualCommands-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name holonomic_robot-srv:<ManualCommands-request> is deprecated: use holonomic_robot-srv:ManualCommands-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <ManualCommands-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader holonomic_robot-srv:name-val is deprecated.  Use holonomic_robot-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <ManualCommands-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader holonomic_robot-srv:order-val is deprecated.  Use holonomic_robot-srv:order instead.")
  (order m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ManualCommands-request>)))
  ...
  "holonomic_robot/ManualCommandsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ManualCommands-request)))
  "Returns string type for a service object of type 'ManualCommands-request"
  "holonomic_robot/ManualCommandsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ManualCommands-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ManualCommands-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name holonomic_robot-srv:<ManualCommands-response> is deprecated: use holonomic_robot-srv:ManualCommands-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <ManualCommands-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader holonomic_robot-srv:response-val is deprecated.  Use holonomic_robot-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ManualCommands-response>)))
  ...
  "holonomic_robot/ManualCommandsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ManualCommands-response)))
  "Returns string type for a service object of type 'ManualCommands-response"
  "holonomic_robot/ManualCommandsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ManualCommands)))
  ...
  "holonomic_robot/ManualCommands")