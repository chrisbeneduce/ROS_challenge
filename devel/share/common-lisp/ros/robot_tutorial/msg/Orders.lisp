...
(cl:in-package robot_tutorial-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Orders>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Orders)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_tutorial-msg:<Orders> is deprecated: use robot_tutorial-msg:Orders instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Orders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_tutorial-msg:name-val is deprecated.  Use robot_tutorial-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <Orders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_tutorial-msg:order-val is deprecated.  Use robot_tutorial-msg:order instead.")
  (order m))
